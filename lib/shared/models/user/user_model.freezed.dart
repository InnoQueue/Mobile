...
class _$_UserModel implements _UserModel {
  const _$_UserModel(
      ...
      @JsonKey(name: 'user') required this.name,
  ...
  @override
  String toString() {
    return 'UserModel(id: $id, name: $name, expenses: $expenses)';
  }
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      {@JsonKey(name: 'user_id') required int id,
      @JsonKey(name: 'user') required String name,
      @JsonKey(name: 'expenses') required double expenses}) = _$_UserModel;
