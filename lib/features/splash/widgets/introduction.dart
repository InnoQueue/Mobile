...
class IntroductionPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final mainColor =
        Theme.of(context).primaryColorBrightness == Brightness.dark ? Colors.grey[900] : Colors.blueGrey[50];
    final oppositeColor =
        Theme.of(context).primaryColorBrightness != Brightness.dark ? Colors.grey[900] : Colors.blueGrey[50];

    var pageDecoration = PageDecoration(
      titlePadding: EdgeInsets.only(top: MediaQuery.of(context).size.height / 10),
      titleTextStyle: TextStyle(fontSize: 28.0, fontWeight: FontWeight.w700, color: oppositeColor),
      bodyTextStyle: TextStyle(fontSize: 16.0, letterSpacing: 1.1, height: 1.5, color: oppositeColor),
    ...
    return IntroductionScreen(
                ...
                children: [
                  (AppRes.howToUse[i]['header-img'] != null
                      ? Padding(
                          ...
                          child: Image.asset(AppRes.howToUse[i]['header-img']!, width: 64),
                        )
                      : const SizedBox.shrink()),
                  Text(AppRes.howToUse[i]['title'] ?? "", style: pageDecoration.titleTextStyle),
                ],
              ),
              bodyWidget: Column(
      ...
      skipOrBackFlex: 1,
      nextFlex: 1,
      done: Text('Continue', style: pageDecoration.bodyTextStyle.copyWith(fontSize: 14, fontWeight: FontWeight.w600)),
